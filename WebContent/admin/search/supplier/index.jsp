    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
          	<li class="active"><a>Search Supplier</a></li>
	      ...
	      <ul class="nav nav-sidebar">
        	...
        	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        		<div class="jumbotron">
        			...
        			<center>
        				<div id="alert"></div>
        				<form class="form-horizontal" name="searchSupForm" action="SearchSupplier.jsp" method="post" onsubmit="return validateSupForm()">
